...
class ReceitasDetalhes extends Component {
    ...
    getReceitaId = () =>{
        fetch("http://localhost:5000/api/Receita/1")
            .then(response => response.json())
            .then(data => this.setState( {informacoes : data} ))
    }
        ...
        return (
            <div>
                ...
                <main>
                    ...
                    {
                        this.state.listaReceitasId.map(function(receitadetalhe){
                            return(
                                <div id="centralizar_pagina_produtor">            
                                    ...
                                    <div id="box_informacoes">
                                        ...
                                        <br/><br/>
                                        <p>
                                            {receitadetalhe.informacoes.descricaoIngrediente}
