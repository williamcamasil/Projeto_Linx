...
VALUES
    ...
    ('Colaborador', 'colaborador@gmail.com', 'colab123colab', 1, '000.000.000-00', 'Url/100/colaporador1.jpg', '', '', 2),
    ('Usuario', 'usuario@gmail.com', 'usu123usu', 0, 'Cliente', '(00) 0000-0000', '', 4);

INSERT INTO Colaborador
    (ImgPerfil, RazaoSocial, DocumentoColab, FazEntrega, SobreColab, IdUsuario)
VALUES
...
INSERT INTO Produto
    (NomeProduto, ImgProduto, IdSobreProduto)
VALUES
    ('Cenoura', 'url/123/cenoura.jpg', 1);

INSERT INTO RegistroProduto
    (IdProduto, IdColaborador)
VALUES
    (1, 2);

INSERT INTO ReservaProduto
    (Quantidade, IdProduto, IdUsuario)
VALUES
    (10.2, 1, 4);